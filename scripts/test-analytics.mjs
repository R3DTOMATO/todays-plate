...
test('HTTP admin authentication, allowlist, persistence, acknowledgements and test filtering',async()=>{
 ...
 const child=spawn(process.execPath,['--import',preload,'server/nearby-proxy.mjs'],{env:{...process.env,PORT:String(port),DATA_DIR:dir,FIREBASE_PROJECT_ID:'fixture',FIREBASE_CLIENT_EMAIL:'fixture@example.test',FIREBASE_PRIVATE_KEY:'fixture',ADMIN_UIDS:'admin',ANALYTICS_EXCLUDED_IDS:''},stdio:['ignore','pipe','pipe']});
