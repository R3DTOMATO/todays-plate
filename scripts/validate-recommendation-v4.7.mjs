...
assert(pkg.version === '4.7.0', 'package version must be 4.7.0');
assert(app.includes("const APP_VERSION = 'korea-beta-v4.7'"), 'APP_VERSION is not v4.7');
assert(index.includes('app.js?v=4.7.0'), 'index cache version is not v4.7.0');
